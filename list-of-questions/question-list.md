...
108. Serialize and Deserialize BST -- We need to put the root in the first place, so there are only two methods, \(1\) BFS  and  \(2\) DFS. Need to Take advantage of BST \(no need of serialize those null node\). Use array to deserialize is enough.
