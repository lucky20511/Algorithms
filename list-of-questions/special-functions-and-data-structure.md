# Java - Special Function & Data Structure
...
deque -&gt; peekLast,  peekFirst, offerLast, offerFirst, pollFIrst, pollLast

### Binary Search

If we need to find the minimum value, we need to take care of the following situations:
...
### Replacement of Global Variable

1.Data Structure  \(Array, List, Map, Set, PQ, Queue........ \)

2.Object **cannot** be used as global variable.
